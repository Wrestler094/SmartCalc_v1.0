...
# Project:  calc.pro
# Template: app
# Command: /usr/local/bin/qmake -o Makefile calc.pro -config release
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = calc1.0.0
DISTDIR = /Users/maddiega/Desktop/C7_SmartCalc_v1.0-0/src/.tmp/calc1.0.0
...
DIST          = /usr/local/share/qt/mkspecs/features/spec_pre.prf \
		...
		calc.pro smartcalc.h \
		mainwindow.h \
		qcustomplot.h expression-handler.c \
		lists-handler.c \
		smartcalc.c \
		main.cpp \
		mainwindow.cpp \
...
EXPORT__PRO_FILE_ = /Users/maddiega/Desktop/C7_SmartCalc_v1.0-0/src/calc.pro
...
calc.app/Contents/MacOS/calc: ui_mainwindow.h $(OBJECTS)  
	@test -d calc.app/Contents/MacOS/ || mkdir -p calc.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: calc.pro /usr/local/share/qt/mkspecs/macx-clang/qmake.conf /usr/local/share/qt/mkspecs/features/spec_pre.prf \
		/usr/local/share/qt/mkspecs/features/device_config.prf \
		/usr/local/share/qt/mkspecs/common/unix.conf \
		/usr/local/share/qt/mkspecs/common/mac.conf \
		/usr/local/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile calc.pro -config release
...
calc.app/Contents/Info.plist: 
	...
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.calc,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.calc,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},11,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,calc,g" -e "s,@LIBRARY@,calc,g" -e "s,\$${EXECUTABLE_NAME},calc,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" /usr/local/share/qt/mkspecs/macx-clang/Info.plist.app >calc.app/Contents/Info.plist

all: Makefile \
		calc.app/Contents/PkgInfo \
		calc.app/Contents/Resources/empty.lproj \
		calc.app/Contents/Info.plist calc.app/Contents/MacOS/calc

dvi:
	open dvi.html

tests:
	@gcc tests.c expression-handler.c lists-handler.c smartcalc.c $(FLAGS_PLATFORM) -o tests.o
	@./tests.o

gcov_report:
	@gcc --coverage expression-handler.c lists-handler.c smartcalc.c tests.c $(FLAGS_PLATFORM) -o gсov_report.o
	@./gсov_report.o
	@lcov -t smartcalc_tests -o smartcalc_tests.info -c -d .
	@genhtml -o report smartcalc_tests.info
...
distdir: FORCE
	...
	$(COPY_FILE) --parents smartcalc.h mainwindow.h qcustomplot.h $(DISTDIR)/
	$(COPY_FILE) --parents expression-handler.c lists-handler.c smartcalc.c main.cpp mainwindow.cpp qcustomplot.cpp $(DISTDIR)/
...
moc_mainwindow.cpp: mainwindow.h \
	...
	/usr/local/share/qt/libexec/moc $(DEFINES) --include /Users/maddiega/Desktop/C7_SmartCalc_v1.0-0/src/moc_predefs.h -I/usr/local/share/qt/mkspecs/macx-clang -I/Users/maddiega/Desktop/C7_SmartCalc_v1.0-0/src -I/usr/local/lib/QtPrintSupport.framework/Headers -I/usr/local/lib/QtWidgets.framework/Headers -I/usr/local/lib/QtGui.framework/Headers -I/usr/local/lib/QtCore.framework/Headers -I/usr/local/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX12.1.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/13.0.0/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX12.1.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/usr/local/lib mainwindow.h -o moc_mainwindow.cpp
...
moc_qcustomplot.cpp: qcustomplot.h \
		...
		moc_predefs.h \
		/usr/local/share/qt/libexec/moc
	/usr/local/share/qt/libexec/moc $(DEFINES) --include /Users/maddiega/Desktop/C7_SmartCalc_v1.0-0/src/moc_predefs.h -I/usr/local/share/qt/mkspecs/macx-clang -I/Users/maddiega/Desktop/C7_SmartCalc_v1.0-0/src -I/usr/local/lib/QtPrintSupport.framework/Headers -I/usr/local/lib/QtWidgets.framework/Headers -I/usr/local/lib/QtGui.framework/Headers -I/usr/local/lib/QtCore.framework/Headers -I/usr/local/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX12.1.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/13.0.0/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX12.1.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/usr/local/lib qcustomplot.h -o moc_qcustomplot.cpp
...
expression-handler.o: expression-handler.c smartcalc.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o expression-handler.o expression-handler.c

lists-handler.o: lists-handler.c smartcalc.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o lists-handler.o lists-handler.c

smartcalc.o: smartcalc.c smartcalc.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o smartcalc.o smartcalc.c
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/calc/bin || mkdir -p $(INSTALL_ROOT)/opt/calc/bin
	$(DEL_FILE) -r $(INSTALL_ROOT)/opt/calc/bin/calc.app
	
	$(QINSTALL) calc.app $(INSTALL_ROOT)/opt/calc/bin/calc.app
	-$(STRIP) $(INSTALL_ROOT)/opt/calc/bin/calc.app/Contents/MacOS/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/opt/calc/bin/calc.app
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/calc/bin/ 
